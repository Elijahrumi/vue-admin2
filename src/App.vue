  ...
  <!-- BEGIN: Header-->
    ...
    <ul class="display-none" id="default-search-main">
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img src="assets/images/icon/pdf-image.png" width="24" height="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img src="assets/images/icon/doc-image.png" width="24" height="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img src="assets/images/icon/xls-image.png" width="24" height="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img src="assets/images/icon/jpg-image.png" width="24" height="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img class="circle" src="assets/images/avatar/avatar-7.png" width="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img class="circle" src="assets/images/avatar/avatar-8.png" width="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img class="circle" src="assets/images/avatar/avatar-10.png" width="30" alt="sample image"></div>
        ...
        <li class="auto-suggestion"><a class="collection-item" href="#">
                <div class="display-flex">
                    <div class="display-flex align-item-center flex-grow-1">
                        <div class="avatar"><img class="circle" src="assets/images/avatar/avatar-12.png" width="30" alt="sample image"></div>
                        <div class="member-info display-flex flex-column"><span class="black-text">Anna Strong</span><small class="grey-text">Web Designer</small></div>
                    </div>
                </div>
            </a></li>
                                ...
                                <div class="card recent-buyers-card animate fadeUp">
                                    <div class="card-content">
                                        ...
                                        <ul class="collection mb-0">
                                            <li class="collection-item avatar">
                                                <img src="assets/images/avatar/avatar-7.png" alt="" class="circle" />
                                            ...
                                            <li class="collection-item avatar">
                                                <img src="assets/images/avatar/avatar-3.png" alt="" class="circle" />
